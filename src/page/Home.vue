<template>
    <header class="bg-pink-100 border-2 border-black border-b-4 rounded-lg h-60 flex flex-col justify-end p-6">
    ...
    <div class="grid md:grid-cols-2 gap-6">
        <RouterLink 
            ...
            class="hover:bg-opacity-70 min-h-52 border-2 border-black border-b-4 rounded-lg flex flex-col justify-between p-6 hover:-translate-y-1 transition duration-300"
            :class="[{'md:col-span-2': i == apps.length - 1 && i % 2 == 0}, app.background]"
        >
    ...
    <div class="bg-blue-100 border-2 border-black border-b-4 rounded-lg p-6 space-y-6">
